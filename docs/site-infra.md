...
- [Decision rationale](#decision-rationale)
  - [Why Hugo + Docsy](#why-hugo--docsy)
  - [Why not make Hugo/Docsy the contract](#why-not-make-hugodocsy-the-contract)
  - [Why not use alias tags as versions](#why-not-use-alias-tags-as-versions)
  - [Why not let sub-projects customize rendering](#why-not-let-sub-projects-customize-rendering)
- [Content ownership model](#content-ownership-model)
  - [Main repository](#main-repository)
  - [Sub-project repositories](#sub-project-repositories)
- [Sub-project contract](#sub-project-contract)
  - [Draft metadata schema](#draft-metadata-schema)
  - [Suggested defaults](#suggested-defaults)
  - [Minimal metadata example](#minimal-metadata-example)
  - [Proposed supported content profile](#proposed-supported-content-profile)
  - [Goals of the supported subset](#goals-of-the-supported-subset)
  - [Guaranteed portable features](#guaranteed-portable-features)
  - [Markdown expectations](#markdown-expectations)
  - [AsciiDoc expectations](#asciidoc-expectations)
  - [Linking rules](#linking-rules)
  - [Asset rules](#asset-rules)
  - [Metadata rules](#metadata-rules)
  - [Admonitions and rich formatting](#admonitions-and-rich-formatting)
  - [Explicitly prohibited or unsupported features](#explicitly-prohibited-or-unsupported-features)
  - [Validation expectation](#validation-expectation)
- [Version model](#version-model)
  - [Unreleased docs](#unreleased-docs)
  - [Released docs](#released-docs)
  - [Alias tags](#alias-tags)
  - [Lifecycle state](#lifecycle-state)
  - [Recommended lifecycle metadata model](#recommended-lifecycle-metadata-model)
  - [Draft lifecycle example](#draft-lifecycle-example)
  - [Lifecycle interpretation rules](#lifecycle-interpretation-rules)
  - [Why line-level lifecycle metadata matters](#why-line-level-lifecycle-metadata-matters)
- [URL scheme](#url-scheme)
  - [Goals for the URL scheme](#goals-for-the-url-scheme)
  - [Canonical paths](#canonical-paths)
  - [URL behavior by version type](#url-behavior-by-version-type)
  - [Convenience redirects](#convenience-redirects)
  - [Project landing pages](#project-landing-pages)
  - [Search and indexing implications](#search-and-indexing-implications)
- [Redirect and indexing policy](#redirect-and-indexing-policy)
  - [Indexable content](#indexable-content)
  - [Non-indexable content](#non-indexable-content)
  - [Canonical URL rules](#canonical-url-rules)
  - [Redirect policy](#redirect-policy)
  - [Redirect implementation guidance](#redirect-implementation-guidance)
  - [Robots policy for versioned docs](#robots-policy-for-versioned-docs)
  - [Site-local search policy](#site-local-search-policy)
  - [Sitemap policy](#sitemap-policy)
  - [Why this policy](#why-this-policy)
- [Release snapshot storage](#release-snapshot-storage)
  - [Recommended `versioned-docs` layout](#recommended-versioned-docs-layout)
- [Aggregation contract](#aggregation-contract)
  - [Proposed staged tree](#proposed-staged-tree)
  - [Staging rules](#staging-rules)
  - [Generated lifecycle metadata](#generated-lifecycle-metadata)
  - [Why this boundary matters](#why-this-boundary-matters)
- [Workspace model for local development](#workspace-model-for-local-development)
- [Central sub-project catalog](#central-sub-project-catalog)
  - [Responsibilities of the catalog](#responsibilities-of-the-catalog)
  - [Draft catalog format](#draft-catalog-format)
  - [Catalog design notes](#catalog-design-notes)
  - [Precedence rules](#precedence-rules)
  - [Local workspace overrides](#local-workspace-overrides)
- [Build tooling](#build-tooling)
- [CI and publishing model](#ci-and-publishing-model)
  - [Recommended baseline event flow](#recommended-baseline-event-flow)
  - [Recommended publication flow](#recommended-publication-flow)
  - [Recommended concurrency model](#recommended-concurrency-model)
  - [Suggested manifest-based build input](#suggested-manifest-based-build-input)
- [Search and indexing](#search-and-indexing)
- [Security constraints](#security-constraints)
- [Follow-ups](#follow-ups)
  - [Sub-project-triggered publication](#sub-project-triggered-publication)
  - [Potential trigger transport](#potential-trigger-transport)
  - [Potential authentication model](#potential-authentication-model)
  - [Potential dispatch payload](#potential-dispatch-payload)
  - [Potential validation rules](#potential-validation-rules)
